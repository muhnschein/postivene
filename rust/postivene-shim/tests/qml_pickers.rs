//! The three picker pages, loaded on their own.
//!
...
/// library picker is the attach tray's, and takes a video as readily as
/// a picture.
const PICKERS: [(&str, &str); 3] = [
    ...
    ("AttachLibraryPage.qml", "/home/user/Videos/clip.mp4"),
